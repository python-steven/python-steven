...
//            query_analysis_post['start_tim']=select_end
            ...
            $("#total_count_14").html(result['data'].total_count)//共有多少数据
            $("#current_page_14").html(result['data'].page_current)//当前页
            $("#total_page_14").html(result['data'].page_count)//共有多少页码
            ...
            $("#total_count_14").html(0)//共有多少数据
            $("#current_page_14").html(0)//当前页
            $("#total_page_14").html(0)//共有多少页码
            $("#previous_a").parent().addClass("disabled")
            $("#next_a").parent().addClass("disabled")
        }
    }
