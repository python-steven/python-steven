    ...
            },
     success:function(result){
            if(result['code'] === 200){
                ...
                $("#total_count_7").html(result['data'].total_count)//共有多少数据
                $("#current_page_7").html(result['data'].page_current)//当前页
                $("#total_page_7").html(result['data'].page_count)//共有多少页码
                if(page_train['page'] == '1' ){
                    $("#mon_previous").parent().addClass("disabled")
                }
                ...
                $("#total_count_7").html(0)//共有多少数据
                $("#current_page_7").html(0)//当前页
                $("#total_page_7").html(0)//共有多少页码
                $("#m_monitor").empty()
                $("#mon_previous").parent().addClass("disabled")
                $("#mon_next").parent().addClass("disabled")
            }
