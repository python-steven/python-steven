...
//                    if(maintain_data[i].Location== null){(maintain_data[i].Location=""}
                ...
                $("#total_count_4").html(result['data'].total_count)//共有多少数据
                $("#current_page_4").html(result['data'].page_current)//当前页
                $("#total_page_4").html(result['data'].page_count)//共有多少页码
                if(page_maintain['page'] == '1'){
                    $("#previous_m").parent().addClass("disabled")
                }
                ...
                $("#total_count_4").html(0)//共有多少数据
                $("#current_page_4").html(0)//当前页
                $("#total_page_4").html(0)//共有多少页码
                $("#next_m").parent().addClass("disabled")
                $("#previous_m").parent().addClass("disabled")
            }
        }
     ...
     $.ajax({
        ...
        success:function(result){
            ...
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_5").html(result['data'].total_count)//共有多少数据
                $("#current_page_5").html(result['data'].page_current)//当前页
                $("#total_page_5").html(result['data'].page_count)//共有多少页码
                if(page_log_add['page'] == '1' ){
                    $("#previous_add_log").parent().addClass("disabled")
                }
                ...
                $("#total_count_5").html(0)//共有多少数据
                $("#current_page_5").html(0)//当前页
                $("#total_page_5").html(0)//共有多少页码
                $("#add_equipment_log").empty()
                $("#next_add_log").parent().addClass("disabled")
                $("#previous_add_log").parent().addClass("disabled")
            }
    ...
    $.ajax({
        ...
        success:function(result){
            ...
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_6").html(result['data'].total_count)//共有多少数据
                $("#current_page_6").html(result['data'].page_current)//当前页
                $("#total_page_6").html(result['data'].page_count)//共有多少页码
                if(page_main_log['page'] == '1'){
                    $("#previous_lo").parent().addClass("disabled")
                }
                ...
                $("#total_count_6").html(0)//共有多少数据
                $("#current_page_6").html(0)//当前页
                $("#total_page_6").html(0)//共有多少页码
                $("#next_lo").parent().addClass("disabled")
                $("#previous_lo").parent().addClass("disabled")
            }
        }
...
function query_main(){
    ...
    if( sn=="" && pn == ""&& status == "" && next_time == ""&& maintainers == ""&& location == "" && next_time_1 ==""){
    ...
    'url':'/maintain/maintain-query-operation/',
        success:function(result){
            if(result['code'] === 200){
                ...
                if(typeof(mt_qu_data) !="undefined"){
                    var status
                    var status_class
                    ...
                    data_count = result['data'].page_count
                    $("#total_count_15").html(result['data'].total_count)//共有多少数据
                    $("#current_page_15").html(result['data'].page_current)//当前页
                    $("#total_page_15").html(result['data'].page_count)//共有多少页码
                ...
                $("#total_count_15").html(0)//共有多少数据
                $("#current_page_15").html(0)//当前页
                $("#total_page_15").html(0)//共有多少页码
               }
            }else{
                $("#total_count_15").html(0)//共有多少数据
                $("#current_page_15").html(0)//当前页
