...
//                console.log(data)
                ...
                $("#total_count_8").html(result['data'].total_count)//共有多少数据
                $("#current_page_8").html(result['data'].page_current)//当前页
                $("#total_page_8").html(result['data'].page_count)//共有多少页码
                if(page_user['page'] == '1'){
                    $("#previous_u").parent().addClass("disabled")
                }
                ...
                $("#total_count_8").html(0)//共有多少数据
                $("#current_page_8").html(0)//当前页
                $("#total_page_8").html(0)//共有多少页码
...
        },
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_9").html(result['data'].total_count)//共有多少数据
                $("#current_page_9").html(result['data'].page_current)//当前页
                $("#total_page_9").html(result['data'].page_count)//共有多少页码
                if(page_customer['page'] == '1'){
                    $("#previous_cu").parent().addClass("disabled")
                }
                if(Number(page_customer['page']) >= data_count){
                 ...
                 $("#total_count_9").html(0)//共有多少数据
                $("#current_page_9").html(0)//当前页
                $("#total_page_9").html(0)//共有多少页码
                alert(result['message'])
                $("#next_cu").parent().addClass("disabled")
            }
        }
...
//            console.log(result['data'])
            ...
            data_count = result['data'].page_count
            $("#total_count_10").html(result['data'].total_count)//共有多少数据
            $("#current_page_10").html(result['data'].page_current)//当前页
            $("#total_page_10").html(result['data'].page_count)//共有多少页码
            if(page_partname['page'] == '1'){
                $("#previous_p").parent().addClass("disabled")
            }
            ...
            $("#total_count_10").html(0)//共有多少数据
            $("#current_page_10").html(0)//当前页
            $("#total_page_10").html(0)//共有多少页码
            alert(result['message'])
            $("#next_p").parent().addClass("disabled")
        }
    }
...
        },
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_11").html(result['data'].total_count)//共有多少数据
                $("#current_page_11").html(result['data'].page_current)//当前页
                $("#total_page_11").html(result['data'].page_count)//共有多少页码
                ...
                $("#total_count_11").html(0)//共有多少数据
                $("#current_page_11").html(0)//当前页
                $("#total_page_11").html(0)//共有多少页码
                $("#Previous_res").parent().addClass("disabled")
                $("#next_res").parent().addClass("disabled")
            }
        }
...
        },
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_12").html(result['data'].total_count)//共有多少数据
                $("#current_page_12").html(result['data'].page_current)//当前页
                $("#total_page_12").html(result['data'].page_count)//共有多少页码
                ...
                $("#total_count_12").html(0)//共有多少数据
                $("#current_page_12").html(0)//当前页
                $("#total_page_12").html(0)//共有多少页码
                $("#Previous_pj").parent().addClass("disabled")
                $("#Next_pj").parent().addClass("disabled")
            }
        }
...
        },
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_13").html(result['data'].total_count)//共有多少数据
                $("#current_page_13").html(result['data'].page_current)//当前页
                $("#total_page_13").html(result['data'].page_count)//共有多少页码
                console.log(page_project)
                if(page_subjects['page'] == '1'){
                    $("#Previous_sj").parent().addClass("disabled")
                }
...
//                alert(result['message'])
                $("#total_count_13").html(0)//共有多少数据
                $("#current_page_13").html(0)//当前页
                $("#total_page_13").html(0)//共有多少页码
                $("#Previous_sj").parent().addClass("disabled")
                $("#Next_sj").parent().addClass("disabled")
            }
        }
