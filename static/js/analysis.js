    ...
    'url':'/analysis/analysis-data/',
        success:function(result){
            if(result['code'] === 200){
                ...
                $("#total_count_3").html(result['data'].total_count)//共有多少数据
                $("#current_page_3").html(result['data'].current_page)//当前页
                $("#total_page_3").html(result['data'].count_page)//共有多少页码
                if(page_statistic['page'] == '1'){
                    $("#previous_statistic").parent().addClass("disabled")
                }
                ...
                $("#total_count_3").html(0)//共有多少数据
                $("#current_page_3").html(0)//当前页
                $("#total_page_3").html(0)//共有多少页码
                console.log(result['data'])
                $("#next_statistic").parent().addClass("disabled")
                $("#previous_statistic").parent().addClass("disabled")
            }
    ...
    $.ajax({
        ...
        success:function(result){
            if(result['code'] === 200){
                ...
                $("#total_count_3").html(result['data'].total_count)//共有多少数据
                $("#current_page_3").html(result['data'].page_current)//当前页
                $("#total_page_3").html(result['data'].page_count)//共有多少页码
