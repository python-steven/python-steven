    ...
    $.ajax({
        ...
        success:function(result){
            if(result['code'] === 200){
                ...
                $("#total_count").html(result['data'].total_count)//共有多少数据
                $("#current_page").html(result['data'].page_current)//当前页
                $("#count_page").html(result['data'].page_count)//共有多少页码
                ...
                $("#total_count").html(0)//共有多少数据
                $("#current_page").html(0)//当前页
                $("#count_page").html(0)//共有多少页码
                $("#next_page").parent().addClass("disabled")
            }
        }
    })
    ...
    $.ajax({
        ...
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].page_count
                $("#total_count_1").html(result['data'].total_count)//共有多少数据
                $("#current_page_1").html(result['data'].page_current)//当前页
                $("#total_page_1").html(result['data'].page_count)//共有多少页码
                if(page_signed_obj['page'] == '1'){
                    $("#previous_signed").parent().addClass("disabled")
                }
                ...
                $("#total_count_1").html(0)//共有多少数据
                $("#current_page_1").html(0)//当前页
                $("#total_page_1").html(0)//共有多少页码
                $("#next_signed").parent().addClass("disabled")
                $("#previous_signed").parent().addClass("disabled")
            }
        }
    ...
    $.ajax({
        ...
        success:function(result){
            if(result['code'] === 200){
                ...
                data_count = result['data'].count_page
                $("#total_count_2").html(result['data'].total_count)//共有多少数据
                $("#current_page_2").html(result['data'].current_page)//当前页
                $("#total_page_2").html(result['data'].count_page)//共有多少页码
                ...
                $("#total_count_2").html(0)//共有多少数据
                $("#current_page_2").html(0)//当前页
                $("#total_page_2").html(0)//共有多少页码
                $('#statement_detail').empty()
                $("#previous_statement").parent().addClass("disabled")
                $("#next_statement").parent().addClass("disabled")
            }
...
function query_date_budget(){
    ...
    var query_formId = $("#query_FormId").val()
